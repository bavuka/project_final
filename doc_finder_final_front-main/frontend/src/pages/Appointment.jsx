        ...
        for (let i = 0; i < 7; i++) {
            ...
            while (currentDate < endTime) {
                ...
                const isWithinAvailableTime =
                    (timeInMinutes >= 600 && timeInMinutes < 750) ||   
                    (timeInMinutes >= 810 && timeInMinutes < 990) ||   
                    (timeInMinutes >= 1050 && timeInMinutes < 1230);   

                if (isSlotAvailable && isWithinAvailableTime) {
                    timeSlots.push({
    ...
    return docInfo ? (
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
                ...
                <div className='flex flex-wrap gap-3 items-center max-w-full overflow-x-auto mt-4'>
